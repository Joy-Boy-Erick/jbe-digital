...
const ServiceCard: React.FC<{ service: typeof SERVICES[0]; index: number; isVisible: boolean }> = ({ service, index, isVisible }) => {
    return (
        <div 
            className={`p-8 rounded-2xl border bg-white/40 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 backdrop-blur-xl shadow-lg hover:-translate-y-2 hover:shadow-2xl hover:border-purple-400/50 transition-all duration-500`}
...
const Services: React.FC = () => {
    ...
    return (
        <section id="services" className="py-20 lg:py-32 bg-white dark:bg-slate-900">
