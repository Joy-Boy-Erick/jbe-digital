...
const Contact: React.FC = () => {
    ...
    return (
        <section id="contact" className="relative py-20 lg:py-32 overflow-hidden bg-white dark:bg-slate-900">
             <div className="absolute inset-0 z-0 opacity-5 dark:opacity-[0.03] gradient-bg"></div>
